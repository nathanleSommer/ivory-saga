...
public class ChaptersController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<ChapterResponse>>> GetChapters(
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return Ok(_mapper.Map<IReadOnlyList<ChapterResponse>>(response));
        }
    ...
    [HttpPost]
    public async Task<ActionResult<SagaResponse>> CreateChapter(
        [FromRoute] SagaReference reference,
    ...
    public async Task<ActionResult> UpdateChapter(
        ...
        CancellationToken cancellationToken)
    {
        var command = new UpdateChapterCommand(reference.SagaId, reference.ChapterId, request.NewContent);
